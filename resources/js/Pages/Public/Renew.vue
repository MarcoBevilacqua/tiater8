<template #guest>
    <div>
        <div class="mt-5 md:mt-10 lg:mt-10 md:px-12 lg:px-24">
            ...
            <div class="grid grid-cols-3 md:grid md:grid-cols-3 md:gap-2">
                <div class="col-span-3 mt-10 md:mt-5 md:col-span-3 text-center">
                    <h2
                        class="mt-2 text-center text-2xl xs:text-sm font-extrabold text-gray-900"
                    >
                        Conferma la tua mail per rinnovare la tessera
                    </h2>
                    <div>
                        <small>La mail che hai inserito corrisponde ad una tessera scaduta</small>
                    </div>
                    <small>Inseriscila di nuovo per rinnovare il tuo abbonamento</small>
                </div>
                <div
...
export default {
    ...
    setup() {
        ...
        function submit() {
            form.post("/over/subscriptions/renew", {
