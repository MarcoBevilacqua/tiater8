<template>
    ...
    <form @submit.prevent="submit">
        <div>
            ...
            <breeze-input id="email" v-model="form.email" autocomplete="username" autofocus class="mt-1 block w-full"
                          name="email"
                          required type="email"/>
        </div>
        ...
        <div class="mt-4">
            ...
            <breeze-input id="password" v-model="form.password" autocomplete="current-password"
